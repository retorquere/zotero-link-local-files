              ...
              <xsl:for-each select="RDF:RDF/RDF:Description/em:targetApplication">
                <em:targetApplication>
                  <RDF:Description>
                    ...
                    <em:updateLink>https://raw.github.com/friflaj/zotero-link-local-files/master/<xsl:value-of select="$xpi"/></em:updateLink>

                    <em:updateInfoURL>https://github.com/friflaj/zotero-link-local-files</em:updateInfoURL>
                  </RDF:Description>
                </em:targetApplication>
              </xsl:for-each>
            </RDF:Description>
